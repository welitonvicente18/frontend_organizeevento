...
<template>
    <div>
        ...
        <button class="px-6 py-3 mt-3 font-medium tracking-wide text-white bg-indigo-600 rounded-md hover:bg-indigo-500 focus:outline-none"
                @click="open = true">
            Open Modal
        </button>
                ...
                <div class="px-6 py-4 text-left modal-content">
                    ...
                    <div class="flex items-center justify-between pb-3">
                        ...
                        <div class="z-50 cursor-pointer modal-close" @click="open = false">
                            <svg class="text-black fill-current"
                                 xmlns="http://www.w3.org/2000/svg"
                                 width="18"
                                 height="18"
                                 viewBox="0 0 18 18">
