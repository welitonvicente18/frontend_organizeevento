        ...
        <div class="mt-8">
            <form @submit.prevent="submitForm">
                ...
                <div class="mt-4 grid grid-cols-4 gap-2 md:grid-cols-3 sm:grid-cols-1">
                    ...
                    <div class="col-span-1">
                        <CheckToggleComponent id="sobrenome" label="Sobrenome" v-model="formData.campo_extra.sobrenome" />
                    </div>
                    <div class="col-span-2">
                        <CheckToggleComponent id="telefone" label="Telefone" v-model="formData.campo_extra.telefone" />
                    </div>
                    <div class="col-span-1">
                        <CheckToggleComponent id="email" label="E-mail" v-model="formData.campo_extra.email" />
                    </div>
                    <div class="col-span-2">
                        <CheckToggleComponent id="cpf" label="CPF" v-model="formData.campo_extra.cpf" />
                    </div>
                    <div class="col-span-1">
                        <CheckToggleComponent id="data-nascimento" label="Data de Nascimento" v-model="formData.campo_extra.datanascimento" />
                    </div>
                    <div class="col-span-2">
                        <CheckToggleComponent id="sexo" label="Sexo" v-model="formData.campo_extra.sexo" />
                    </div>
                    <div class="col-span-1">
                        <CheckToggleComponent id="estado-2" label="Estado" v-model="formData.campo_extra.estado" />
                    </div>
                    <div class="col-span-2">
                        <CheckToggleComponent id="Cidade" label="Cidade" v-model="formData.campo_extra.cidade" />
                    </div>
                    <div class="col-span-1">
                        <CheckToggleComponent id="endereco" label="Endereço" v-model="formData.campo_extra.endereco" />
                    </div>
                    <div class="col-span-2">
                        <CheckToggleComponent id="cep" label="CEP" v-model="formData.campo_extra.cep" />
                    </div>
                </div>
                <hr class="my-6">
                <div class="flex justify-start mt-6">
                    <button class="px-4 py-2 text-gray-200 bg-green-800 rounded-md hover:bg-green-700 focus:outline-none focus:bg-gray-700"> Salvar Evento </button>
